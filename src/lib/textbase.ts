export const info_thread_init = `안녕하세요! 저는 바다거북 수프 문제를 출제하는 바다거북이에요.
문제를 듣고 싶다면 '!문제'를 입력해주세요.`;

export const error_thread = '오류가 발생했어요';

export const info_placeholder = '질문을 입력해주세요';

export const command_thread_riddle = '!문제';
export const query_thread_riddle = '위의 형식을 따르는 수수께끼를 출제해주세요';

export const query_thread_init = `바다거북 수프 게임은 다음과 같이 진행됩니다.
